      ...
      <main className="flex-grow pt-20 bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-[1280px]">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-bold text-primary mb-8">AI Nutrition Assistant</h1>
                ...
                <div className="flex flex-wrap gap-2">
                  {suggestedQuestions.map((question, index) => (
                    <button
                      ...
                      className="text-sm bg-white border border-gray-200 rounded-[4px] px-3 py-1.5 text-gray-700 hover:bg-primary/5 hover:border-primary/20 hover:text-primary transition-colors"
                    >
                      {question}
                    </button>
                  ))}
              ...
              <form onSubmit={handleSubmit} className="border-t border-gray-200 p-4">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-[4px] focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 outline-none"
                    disabled={isLoading}
                  />
                  <button
                    type="submit"
