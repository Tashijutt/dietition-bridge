      ...
      <div className={`space-y-6 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}>
        ...
        <Tabs defaultValue="all" className="w-full">
          ...
          <TabsContent value="recent" className="mt-6">
            <div className="text-center py-12">
              <User className="mx-auto h-12 w-12 text-gray-400" />
              <h3 className="mt-2 text-lg font-medium text-gray-900">No recent patients</h3>
              <p className="mt-1 text-gray-500">You have no recently added patients.</p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="active" className="mt-6">
            <div className="text-center py-12">
              <User className="mx-auto h-12 w-12 text-gray-400" />
              <h3 className="mt-2 text-lg font-medium text-gray-900">No active plans</h3>
              <p className="mt-1 text-gray-500">No patients with active diet plans.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
