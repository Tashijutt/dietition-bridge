    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-[#21205F] text-white rounded-full shadow-[0px_1px_24px_0px_rgba(0,0,0,0.05),0px_1px_4px_0px_rgba(0,0,0,0.15)] hover:bg-[#21205F]/90 transition-all duration-300 hover:scale-105 group"
      ...
      {isOpen && (
        <div
          className={cn(
            "fixed z-50 bottom-6 right-6 w-[380px] bg-white rounded-2xl shadow-[0px_1px_24px_0px_rgba(0,0,0,0.05),0px_1px_4px_0px_rgba(0,0,0,0.15)] overflow-hidden transition-all duration-300 border border-gray-200",
            isMinimized ? "h-14" : "h-[550px] max-h-[80vh]",
            isOpen ? "animate-slide-up" : ""
          )}
        >
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-[#21205F] text-white">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="p-1.5 rounded-full hover:bg-[#21205F]/70 transition-colors"
              ...
              <form onSubmit={handleSubmit} className="p-4 border-t border-gray-200 bg-gray-50">
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 pr-12 border border-gray-300 rounded-[4px] focus:ring-2 focus:ring-[#21205F] focus:border-transparent transition-all duration-200 outline-none"
                    disabled={isLoading}
                  />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-[#21205F] text-white rounded-[4px] hover:bg-[#21205F]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
